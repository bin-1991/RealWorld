...
class HexEdit : public QAbstractScrollArea
{
    ...
    Q_PROPERTY(QList<Markup> markup READ markup WRITE setMarkup DESIGNABLE false)
...
private:
    ...
    friend class HexEditWidgetPrivate;
    HexEditWidgetPrivate *d;
